    ...
    <div className="grid grid-cols-2 pb-4 border-b-2 border-sky-800">
      ...
      <div className="col-span-2 lg:col-span-1 m-4">
        ...
        <div className="flex flex-wrap justify-center lg:justify-end gap-2 my-4">
          <Link href={'mi-cuenta'} className="uppercase py-1 px-4 border-2 border-sky-800 rounded-3xl text-sky-800 hover:bg-sky-800 hover:text-white font-semibold place-items-center flex justify-center gap-2 h-12 w-40 text-start text-sm"><Image src={'http://via.placeholder.com/464x130/png'} width={30} height={30} alt={""} /> Mi cuenta</Link>
