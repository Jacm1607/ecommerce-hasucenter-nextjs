export const CardProduct = ({ title = "Button", img = "http://via.placeholder.com/350x350", price = `00000 BS.` }): any => {
    return (
        <div className="border-2 border-sky-950 rounded-[50px] w-full h-full flex flex-col">
            <img className="h-3/4 object-none object-center w-full rounded-t-[50px]" src={img} alt="1" />
